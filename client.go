...
import (
	...
	"github.com/connectRN/go-hellosign/model"
)

const (
	// DefaultBaseURL is the Base URL for standard usage
...
// Client is a client for the Hellosign (aka Dropbox Sign) REST API.
type Client struct {
...
// Option is a functional options parameter
